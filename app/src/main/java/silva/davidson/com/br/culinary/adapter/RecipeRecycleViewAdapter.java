...
public class RecipeRecycleViewAdapter extends RecyclerView.Adapter<RecipeRecycleViewAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public RecipeRecycleViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RecipeRecycleViewAdapter.ViewHolder viewHolder, int position) {
